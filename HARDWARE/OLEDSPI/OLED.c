...
void OLED_Init(void)
{
  GPIO_InitTypeDef  GPIO_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE,ENABLE);//使能PORTA~E,PORTG时钟
...
void display_GB2312_u16(unsigned char y,unsigned char x,u16 num)
{
	...
	OLED_Display_GB2312_string(y,x,temp);	/*在第1页，第1列，显示一串16x16点阵汉字或8x16的ASCII字*/	
}
